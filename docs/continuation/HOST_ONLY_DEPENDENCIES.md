...
| Running task state | mission `04bdbc62467f`, namespace `0006` | No | Never restore old PID/lock/claim records as active state. Inspect the original host or start a new lawful mission after loss. |
