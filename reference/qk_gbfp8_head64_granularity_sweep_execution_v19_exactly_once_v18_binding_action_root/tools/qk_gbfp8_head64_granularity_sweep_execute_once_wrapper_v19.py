...
"""Irreversible V19 wrapper launcher; static acceptance alone is not authority."""
...
from qk_gbfp8_head64_granularity_sweep_exactly_once_engine_v19 import (
    Outcome,
    RuntimePaths,
    compact_bytes,
    run_execution,
...
ROOT = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v19_exactly_once_v18_binding_action_root')
...
RUNTIME_ROOT = Path('/home/argustest/ace-2/runtime/qk_gbfp8_head64_granularity_sweep_execution_v19_exactly_once_fdfc33a1')
...
CORE_MANIFEST = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v17_evaluator_diagnostic_preauthority_repair_1_action_root/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EVALUATOR_DIAGNOSTIC_PREAUTHORITY_PACKAGE.json')
...
SCHEMA_HASHES = {
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_AUTHORITY_SCHEMA.json": "50b3a250d94fec6e4575ccf46e0d9551a6c8636238cb7f7620d62a97931799d3",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_CREDENTIAL_SCHEMA.json": "5cc1c35ed9a04943143eac545a638861ea341f4866502584448fb96356a1b582",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_FIRST_TERMINAL_SCHEMA.json": "f542e93524344e77eb95b36eb176bc9a067379b72fcfe066c76e95a9cf4aa6f2",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_LEDGER_SCHEMA.json": "b2a4d85f9f6bc1076ad55c937cb0eb97358d5d2f24c974561d971ad6667a1627",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_OWNER_CLAIM_SCHEMA.json": "4f113e2778c3450718bf83f56aafbd132ec4eac0bc2bc98435dee5ca15319230",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_V18_BINDING_FRESH_L2_ACCEPTANCE_SCHEMA.json": "f841c309f8032a1c1477d6224f7b4262a76613547ddb32c1c49a6943f447f760"
}
PATHS = RuntimePaths(
...
def load_schemas() -> dict[str, Any]:
    ...
    mapping = {
        "owner": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_OWNER_CLAIM_SCHEMA.json",
        "authority": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_AUTHORITY_SCHEMA.json",
        "credential": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_CREDENTIAL_SCHEMA.json",
        "ledger": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_LEDGER_SCHEMA.json",
        "terminal": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_FIRST_TERMINAL_SCHEMA.json",
        "acceptance": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_V18_BINDING_FRESH_L2_ACCEPTANCE_SCHEMA.json",
    }
    validators = {}
...
def transport_attestation(package: dict[str, Any]) -> dict[str, Any]:
    ...
    record = {
        ...
        "immediate_parent_transport_sha256": package["generated_files"]["tools/qk_gbfp8_head64_granularity_sweep_transport_wrapper_v19.py"]["sha256"],
...
def prepare_execution(holder: dict[str, Any], module_loader: Callable[[str, Path], Any]) -> None:
    ...
    holder["adapter"] = module_loader(
        "qk_gbfp8_head64_granularity_sweep_evaluator_adapter_v19",
        CORE_TOOLS / "qk_gbfp8_head64_granularity_sweep_evaluator_adapter_v19.py",
    )
    holder["bridge"] = module_loader(
        "qk_gbfp8_head64_granularity_sweep_production_adapter_bridge_v19",
        CORE_TOOLS / "qk_gbfp8_head64_granularity_sweep_production_adapter_bridge_v19.py",
    )
    result_validation = module_loader(
        "qk_gbfp8_head64_granularity_sweep_result_validation_v19",
        CORE_TOOLS / "qk_gbfp8_head64_granularity_sweep_result_validation_v19.py",
    )
