...
from qk_gbfp8_head64_granularity_sweep_exactly_once_engine_v19 import RuntimePaths, compact_bytes, run_execution, sha256_bytes
import qk_gbfp8_head64_granularity_sweep_evaluator_adapter_v19 as adapter
import qk_gbfp8_head64_granularity_sweep_execute_once_wrapper_v19 as launcher
import qk_gbfp8_head64_granularity_sweep_nominal_records_v19 as nominal
import qk_gbfp8_head64_granularity_sweep_result_validation_v19 as result_validation
...
def validators() -> dict[str, Any]:
    ...
    names = {
        "owner": "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_OWNER_CLAIM_SCHEMA.json",
        "authority": "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_AUTHORITY_SCHEMA.json",
        "credential": "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_CREDENTIAL_SCHEMA.json",
        "ledger": "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_LEDGER_SCHEMA.json",
        "terminal": "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V19_EXACTLY_ONCE_FIRST_TERMINAL_SCHEMA.json",
    }
...
def invoker(scenario: str) -> Callable[..., Any]:
    def invoke(payload: bytes, authority_sha256: str, ledger_sha256: str, publish: Any) -> Any:
        ...
        spec = adapter.InvocationSpec(
            argv=("synthetic-v19-adapter", scenario),
            cwd="/synthetic",
            environment=(("LANG", "C"),),
...
def run_case(name: str, operation: Callable[[RuntimePaths], dict[str, Any]]) -> dict[str, Any]:
    with tempfile.TemporaryDirectory(prefix="v19-wrapper-repair-fixture-") as temporary:
...
def run_fixture() -> dict[str, Any]:
    ...
    return {
        "action_id": ACTION_ID,
        "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v19_exactly_once_synthetic_fixture_report",
        ...
        "status": "PASS_V19_EXACTLY_ONCE_SYNTHETIC_FIXTURE" if passed else "FAIL_V19_EXACTLY_ONCE_SYNTHETIC_FIXTURE",
