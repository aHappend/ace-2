#!/usr/bin/env python3
"""V20 evaluator worker with production and explicitly synthetic modes."""
...
PACKAGE = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v20_bound_path_repair_action_root/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_BOUND_PATH_REPAIR_PACKAGE.json')
ACCEPTANCE = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v20_bound_path_repair_action_root/review/FRESH_L2_STATIC_ACCEPTANCE.json')
...
BINDING_TABLE = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v20_bound_path_repair_action_root/bindings/C02_EXACT_BINDINGS_25.json')
