...
"""Irreversible V20 wrapper launcher; static acceptance alone is not authority."""
...
ROOT = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v20_bound_path_repair_action_root')
...
RUNTIME_ROOT = Path('/home/argustest/ace-2/runtime/qk_gbfp8_head64_granularity_sweep_execution_v20_bound_path_repair_a81f2916')
...
SCHEMA_HASHES = {
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_BOUND_PATH_REPAIR_FRESH_L2_ACCEPTANCE_SCHEMA.json": "2a4cdd9dc9e76e85e9bd5b8d810c401083ccfd867bdec6f4530b7919c04e4171",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_AUTHORITY_SCHEMA.json": "1808bb44e356a44d80538cc221ecdf18221dbc38be983080134308a9492c064a",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_CREDENTIAL_SCHEMA.json": "67cf600dd1c3e87509d7543086bd484588bbb12781527f3e6e7ffb786f310880",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_FIRST_TERMINAL_SCHEMA.json": "9fc3e9917d5723d204d534ce5fbe105aaf680f43c4f3faa760e90a72a69c2b4d",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_LEDGER_SCHEMA.json": "b1e2179ddab1bbc80d53890906fe58d3446494bb0c7b69147105ac083b58827f",
    "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_OWNER_CLAIM_SCHEMA.json": "45504227f245af01386572a2c22e6e20e76185ff9c9eb51f838ac4d2ec4aabb6"
}
PATHS = RuntimePaths(
...
def load_schemas() -> dict[str, Any]:
    ...
    mapping = {
        "owner": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_OWNER_CLAIM_SCHEMA.json",
        "authority": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_AUTHORITY_SCHEMA.json",
        "credential": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_CREDENTIAL_SCHEMA.json",
        "ledger": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_LEDGER_SCHEMA.json",
        "terminal": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_EXACTLY_ONCE_FIRST_TERMINAL_SCHEMA.json",
        "acceptance": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V20_BOUND_PATH_REPAIR_FRESH_L2_ACCEPTANCE_SCHEMA.json",
    }
    validators = {}
...
def transport_attestation(package: dict[str, Any]) -> dict[str, Any]:
    ...
    record = {
        ...
        "immediate_parent_transport_sha256": package["generated_files"]["tools/qk_gbfp8_head64_granularity_sweep_transport_wrapper_v20.py"]["sha256"],
...
def prepare_execution(holder: dict[str, Any], module_loader: Callable[[str, Path], Any]) -> None:
    ...
    holder["adapter"] = module_loader(
        "qk_gbfp8_head64_granularity_sweep_evaluator_adapter_v20",
        CORE_TOOLS / "qk_gbfp8_head64_granularity_sweep_evaluator_adapter_v20.py",
    )
    holder["bridge"] = module_loader(
        "qk_gbfp8_head64_granularity_sweep_production_adapter_bridge_v20",
        CORE_TOOLS / "qk_gbfp8_head64_granularity_sweep_production_adapter_bridge_v20.py",
    )
    result_validation = module_loader(
        "qk_gbfp8_head64_granularity_sweep_result_validation_v20",
        CORE_TOOLS / "qk_gbfp8_head64_granularity_sweep_result_validation_v20.py",
    )
