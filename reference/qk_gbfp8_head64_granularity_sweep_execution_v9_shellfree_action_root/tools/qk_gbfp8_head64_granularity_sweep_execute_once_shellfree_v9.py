#!/usr/bin/env python3
"""Future Base V9 execute-once launcher behind the frozen shell-free transport.
...
PACKAGE = ROOT / "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V9_SHELLFREE_PACKAGE.json"
ACCEPTANCE = ROOT / "review/FRESH_L2_STATIC_ACCEPTANCE.json"
TRANSPORT = ROOT / "tools/qk_gbfp8_head64_granularity_sweep_transport_shellfree_v9.py"
LAUNCHER = ROOT / "tools/qk_gbfp8_head64_granularity_sweep_execute_once_shellfree_v9.py"
...
LOCAL_PATHS = {
    ...
    "transport": TRANSPORT,
    "launcher": LAUNCHER,
    "static_verifier": ROOT / "tools/verify_qk_gbfp8_head64_granularity_sweep_execution_v9_shellfree.py",
...
def _validate_fresh_l2_acceptance(package_bytes: bytes, acceptance_validator: Any) -> str:
    ...
    require(acceptance["artifact_kind"] == "qk_gbfp8_head64_granularity_sweep_execution_v9_shellfree_fresh_l2_static_acceptance", "acceptance kind")
...
def _load_frozen_runtime_modules() -> tuple[ModuleType, ModuleType, ModuleType]:
    ...
    controller = _load_frozen_module("v9_frozen_accepted_v8_controller", ACCEPTED_PATHS["controller"])
    evaluator = _load_frozen_module("v9_frozen_accepted_v8_evaluator", ACCEPTED_PATHS["evaluator"])
    parser_module = _load_frozen_module("v9_frozen_accepted_v8_c02_parser", ACCEPTED_PATHS["c02_parser"])
...
def _authority(context: PreflightContext) -> dict[str, Any]:
    return sealed(
        {
            "action_id": ACTION_ID,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v9_shellfree_authority",
...
def _credential(authority: dict[str, Any]) -> dict[str, Any]:
    return sealed(
        {
            "action_id": ACTION_ID,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v9_shellfree_credential",
    ...
    return sealed(
        {
            "action_id": ACTION_ID,
            "action_retired": True,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v9_shellfree_consumed_ledger",
            "authority_sha256": authority["authority_sha256"],
