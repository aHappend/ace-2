#!/usr/bin/env python3
"""Synthetic-only verifier for the isolated-root Base G16 V2 package."""
...
PACKAGE_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V2_PACKAGE.json"
...
AUTHORITY_REVIEW_MISSION_SHA256 = "02071762c5c9cbd823fecee63bb1537168642a3a56e5a33cf0ca0b1ac8ea6cdf"
...
PACKAGE_SCHEMA_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V2_PACKAGE_SCHEMA.json"
...
def expected_package() -> dict[str, Any]:
    ...
    schema_bindings = {
        "authority_package": {
            **repo_binding(PACKAGE_SCHEMA_REL, sha256_file(ROOT / PACKAGE_SCHEMA_REL)),
            "schema_id": "QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V2_PACKAGE_SCHEMA",
        },
        "credential": {
    ...
    return {
        "action_root_projection": {
            ...
            "namespace_separation": "All accepted V1-relative evaluator paths resolve beneath this distinct V2 action root, never beneath the closed repository-root V1 action.",
        ...
        "artifact_kind": "qk_gbfp8_g16_base_cardinality_one_execution_authority_static_v2_action_root_freeze",
        "authority_controller": {
            ...
            "controller_id": "QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_CONTROLLER_STATIC_V2",
        ...
        "static_verification": {
            "coverage": [
                ...
                "isolated action-root projection and closed repository-root V1 namespace separation",
...
def historical_json_compatibility_checks(package: dict[str, Any]) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="g16-v2-json-") as temporary:
        root = Path(temporary)
        ...
        require(load_canonical_json(canonical) == semantic, "new V2 canonical load")
        checks += 1
    ...
    credential = {
        ...
        "irreversible_action_id": "ace2:g16-base:v2:synthetic",
        "lane_label": "Base",
        "schema_id": CREDENTIAL_SCHEMA_ID,
    }
...
def controller_surface_checks() -> int:
    ...
    return 3 + len(required_functions) + len(mirrored_schema_functions) + 1 + 4
...
def main() -> int:
    ...
    print("QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V2=PASS")
    ...
    print(f"CLOSED_V1_IMMUTABILITY_CHECKS={closed_v1_checks}")
