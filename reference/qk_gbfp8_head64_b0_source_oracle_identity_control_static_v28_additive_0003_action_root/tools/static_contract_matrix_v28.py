...
FUTURE_RUNTIME_NAMESPACE = Path('/home/argustest/ace-2/runtime/qk_gbfp8_head64_b0_source_oracle_identity_control_v28_38571d38_additive_0003_once')
...
def validate_package(package: dict[str, Any]) -> None:
    ...
    require(package["predecessor_preservation"]["failed_additive_predecessor"]["status"] == "IMMUTABLE_FAILED_SEALED_V28_ADDITIVE_0002", "failed additive predecessor semantics")
...
def authority_baseline() -> dict[str, Any]:
    ...
    value = {
        ...
        "identity_bundle_sha256": '089e5145e7c74f8e99b505006305c451fdca3457c584e3f3cf5d05f9857b7714',
