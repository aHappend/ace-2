...
def _load_bound_launch_guard() -> Any:
    ...
    name = "ace2_v27_matrix_bound_literal_b_launch_guard"
...
CANDIDATE = ACTION_ROOT / "tools/verify_qk_gbfp8_head64_role_enforced_acceptance_candidate_v27.py"
POST = ACTION_ROOT / "tools/verify_qk_gbfp8_head64_role_enforced_acceptance_post_acceptance_v27.py"
...
def run_positive(output_root: Path) -> dict[str, Any]:
    candidate_report = output_root / "QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_CANDIDATE_REPORT.json"
    negative_report = output_root / "QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_NEGATIVE_FIXTURE_REPORT.json"
    ...
    require(candidate_value["status"] == "PASS_V27_STATIC_CANDIDATE_PENDING_FRESH_L2", "candidate status")
    require(negative_value["status"] == "PASS_V27_LITERAL_B_MODE_SEAL_AND_SYNTHETIC_MUTATION_REJECTION", "negative status")
    return {
        "action_tree_unchanged": True,
...
def main() -> int:
    ...
    report = {
        "artifact_kind": "qk_gbfp8_head64_role_enforced_acceptance_v27_launch_matrix_report",
        ...
        "status": "PASS_V27_LITERAL_B_LAUNCH_MATRIX_PENDING_FRESH_L2",
    }
    report["report_sha256"] = sha256_bytes(compact_bytes(report))
    output = output_root / "QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_LAUNCH_MATRIX_REPORT.json"
