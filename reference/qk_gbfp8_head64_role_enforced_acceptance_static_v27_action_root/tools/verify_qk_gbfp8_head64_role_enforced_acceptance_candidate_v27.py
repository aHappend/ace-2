#!/usr/bin/env python3
"""Literal-``-B`` and immutable-mode verifier for additive static-only V26."""
...
def _load_bound_launch_guard() -> Any:
    guard_path = Path(__file__).resolve(strict=True).with_name("literal_b_launch_guard_v27.py")
    raw = guard_path.read_bytes()
    if hashlib.sha256(raw).hexdigest() != "3e3f6b1211b6000c4239abf69ecca95a15750e7ef36f0e37387f365267be1d6a":
        raise RuntimeError("LITERAL_B_GUARD_HASH_MISMATCH")
    name = "ace2_v27_bound_literal_b_launch_guard"
...
CANONICAL_ACTION_ROOT = PROJECT_ROOT / "reference/qk_gbfp8_head64_role_enforced_acceptance_static_v27_action_root"
BUILD_ROOT = PROJECT_ROOT / "build/v27-role-enforced-acceptance-static-0004"
PACKAGE = ACTION_ROOT / "QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_PACKAGE.json"
...
ACCEPTANCE_SCHEMA = ACTION_ROOT / "reference/QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_FRESH_L2_ACCEPTANCE_SCHEMA.json"
...
POST_VERIFIER = ACTION_ROOT / "tools/verify_qk_gbfp8_head64_role_enforced_acceptance_post_acceptance_v27.py"
LAUNCH_MATRIX = ACTION_ROOT / "tools/verify_qk_gbfp8_head64_literal_b_launch_matrix_v27.py"
ACCEPTANCE = ACTION_ROOT / "review/FRESH_L2_STATIC_ACCEPTANCE.json"
MISSION = Path("/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/v27roleenforcedacceptance/mission.json")
V25_ROOT = PROJECT_ROOT / "reference/qk_gbfp8_head64_literal_b_mode_seal_static_v25_action_root"
V25_PACKAGE = V25_ROOT / "QK_GBFP8_HEAD64_LITERAL_B_MODE_SEAL_STATIC_V25_PACKAGE.json"
V25_BUILD_ROOT = PROJECT_ROOT / "build/v25-literal-b-mode-seal-static-0002"
V25_CHECKPOINT = Path("/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/v25literalbmodeseal/CHECKPOINT.md")
V25_CONSTRUCTION_RECORD = V25_BUILD_ROOT / "QK_GBFP8_HEAD64_LITERAL_B_MODE_SEAL_STATIC_V25_CONSTRUCTION_RECORD.json"
V25_TERMINAL_FAILURE = V25_BUILD_ROOT / "QK_GBFP8_HEAD64_LITERAL_B_MODE_SEAL_STATIC_V25_TERMINAL_FAILURE.json"
V25_MATRIX_STDERR = V25_BUILD_ROOT / "QK_GBFP8_HEAD64_LITERAL_B_MODE_SEAL_STATIC_V25_MATRIX_STDERR.log"
V26_ROOT = PROJECT_ROOT / "reference/qk_gbfp8_head64_launch_harness_repair_static_v26_action_root"
V26_PACKAGE = V26_ROOT / "QK_GBFP8_HEAD64_LAUNCH_HARNESS_REPAIR_STATIC_V26_PACKAGE.json"
V26_ACCEPTANCE = V26_ROOT / "review/FRESH_L2_STATIC_ACCEPTANCE.json"
V26_BUILD_ROOT = PROJECT_ROOT / "build/v26-launch-harness-repair-static-0003"
V26_POST_REPORT = V26_BUILD_ROOT / "fresh-l2-post-0001/QK_GBFP8_HEAD64_LAUNCH_HARNESS_REPAIR_STATIC_V26_POST_ACCEPTANCE_REPORT.json"
V26_NEGATIVE_REPORT = V26_BUILD_ROOT / "fresh-l2-sealed-0001/QK_GBFP8_HEAD64_LAUNCH_HARNESS_REPAIR_STATIC_V26_NEGATIVE_FIXTURE_REPORT.json"
V26_CHECKPOINT = Path("/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/v26launchharnessrepair/CHECKPOINT.md")
V26_REVIEW_HANDOFF = Path("/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/v26launchharnessrepair/round-0002.json")
REVIEWER_PROVENANCE_GATE = ACTION_ROOT / "tools/reviewer_provenance_v27.py"
...
EXPECTED_ACTION_ID = "ace2:qk-gbfp8-base-v27:role-enforced-acceptance:aaa22c19:additive-0004"
EXPECTED_V26_ACTION_ID = "ace2:qk-gbfp8-base-v26:launch-harness-repair:1e2b5550:additive-0003"
EXPECTED_V25_ACTION_ID = "ace2:qk-gbfp8-base-v25:literal-b-mode-seal:12b1f604:additive-0002"
...
EXPECTED_ACTION_IDENTITY = {
    ...
    "predecessor_action_id": EXPECTED_V26_ACTION_ID,
    "predecessor_failed_immutable": True,
    "retry_replay_resume_repair_reinterpret_permitted": False,
    "runtime_namespace": None,
}
EXPECTED_CLAIM_BOUNDARY = {'authority_or_credential_materialized': False,
 ...
 'v25_accepted_resealed_replayed_or_mutated': False,
 'v25_executed': False,
 'v25_preserved_byte_and_mode_identical': True,
 'v26_accepted_resealed_replayed_or_mutated': False,
 'v26_executed': False,
 'v26_preserved_byte_and_mode_identical': True,
 'v27_executed': False}
...
EXPECTED_FRESH_L2 = {'acceptance_and_external_audit_bind_authoritative_provenance': True,
 'acceptance_path': 'review/FRESH_L2_STATIC_ACCEPTANCE.json',
 'acceptance_schema_file_sha256': 'bb056d28f9c853c30ffd8bb836964b14ec46789990ae620f3834e70355d47593',
 'acceptance_schema_path': 'reference/QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_FRESH_L2_ACCEPTANCE_SCHEMA.json',
...
EXPECTED_MISSION = {'path': '/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/v27roleenforcedacceptance/mission.json',
 'sha256': '48cba17e1f92bbd683a0f5c969e4603ec046d18054419fd016ddb307ffbc0568',
 'size': 3852}
EXPECTED_TOOLCHAIN = {
...
EXPECTED_V25_PRESERVATION = {
    "acceptance_absent": str(V25_ROOT / "review/FRESH_L2_STATIC_ACCEPTANCE.json"),
    "action_root_mode": "0555",
    "checkpoint": {"path": str(V25_CHECKPOINT), "sha256": "0b35aefb5dd399e43d26fd9e56a293078a6e018681d32ef63dac0794bb1bc63b", "size": 4685},
    "construction_record": {"path": str(V25_CONSTRUCTION_RECORD), "sha256": "5b9cb10c4a18f3800ace4b535e4ca68188f3cf2784eb2c318b00442fa0c04658", "size": 709},
    "matrix_stderr": {"path": str(V25_MATRIX_STDERR), "sha256": "e39061e9d614acfa342ac8ba75ccb772b52a8679195602374aafac0b90489344", "size": 363},
    "package": {"path": str(V25_PACKAGE), "sha256": "1e2b555027e8740bc5db17c7cd09ad9ff13bdb74ac1f32a246612135e045207a", "size": 19267},
    "review_directory_mode": "0755",
    "terminal_failure": {"path": str(V25_TERMINAL_FAILURE), "sha256": "32b6b1c2a614587b3f891840068c6672df814cbceb9944371b442349e7f4a951", "size": 1996},
    "terminal_failure_taxonomy": "LAUNCH_NEGATIVE_HARNESS_IMPORT_PATH",
    "v25_action_root": {"entry_count": 18, "file_count": 13, "root": str(V25_ROOT), "tree_sha256": "ca176ab9116e7e0285dc943dbe0123a07cf728df3b6d6cb6a0485c636a24bdae"},
}
EXPECTED_V26_PRESERVATION = {'acceptance': {'path': '/home/argustest/ace-2/reference/qk_gbfp8_head64_launch_harness_repair_static_v26_action_root/review/FRESH_L2_STATIC_ACCEPTANCE.json',
                'sha256': '0bb542230a5df09277fa0020842a62fbc1414231de77612d08f10c17ca49987a',
                'size': 3057},
 'action_root_mode': '0555',
 'checkpoint': {'path': '/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/v26launchharnessrepair/CHECKPOINT.md',
                'sha256': '9eee1526984db53a92d2561de389355d20809fc0632b95e6006434d4b9b2ce9b',
                'size': 8270},
 'invalid_creator_call_id': 'a4eb3b6421614e00bff00611c33a151f',
 'negative_fixture_report': {'path': '/home/argustest/ace-2/build/v26-launch-harness-repair-static-0003/fresh-l2-sealed-0001/QK_GBFP8_HEAD64_LAUNCH_HARNESS_REPAIR_STATIC_V26_NEGATIVE_FIXTURE_REPORT.json',
                             'sha256': 'be397cb4da1e72172efe71b6be38bab79e29afd78cf707d5ee256964fd49723e',
                             'size': 31529},
 'package': {'path': '/home/argustest/ace-2/reference/qk_gbfp8_head64_launch_harness_repair_static_v26_action_root/QK_GBFP8_HEAD64_LAUNCH_HARNESS_REPAIR_STATIC_V26_PACKAGE.json',
             'sha256': 'aaa22c19f76293a582c23b2d57c1f1cfa3344b43dd54961ae2779516bd521c9f',
             'size': 21326},
 'positive_post_report': {'path': '/home/argustest/ace-2/build/v26-launch-harness-repair-static-0003/fresh-l2-post-0001/QK_GBFP8_HEAD64_LAUNCH_HARNESS_REPAIR_STATIC_V26_POST_ACCEPTANCE_REPORT.json',
                          'sha256': 'ae5b0fd327017a59b34739badd5b14b3c84d2f683cb6550b008f40c3352ad279',
                          'size': 1800},
 'provenance_invalid_acceptance': True,
 'review_directory_mode': '0555',
 'review_rejection': {'path': '/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/v26launchharnessrepair/round-0002.json',
                      'sha256': '5ddd248d258296830b8320420576080c18e35ef6d78c68db8a0620fc4fe536a2',
                      'size': 935},
 'v26_action_root': {'entry_count': 19,
                     'file_count': 14,
                     'root': '/home/argustest/ace-2/reference/qk_gbfp8_head64_launch_harness_repair_static_v26_action_root',
                     'tree_sha256': 'bb9b1cdead6cb5f1da518386c6ed523818f22565e4d8fc1bd4c12f833aa2f657',
                     'tree_with_root_sha256': '86c17c45557c92c58ada0afd252fa960184f64c1692df72e085d2e07563427ec'}}
EXPECTED_ROLE_ENFORCEMENT = {'acceptance_and_audit_bind_exact_provenance_identity': True,
 'acceptance_creator_path': 'build/v27-role-enforced-acceptance-static-0004/create_fresh_l2_static_acceptance_v27.py',
 'authoritative_event_log_path': '/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/events.jsonl',
 'authoritative_event_source': 'ARGUS_PROJECT_EVENTS_JSONL',
 'engineer_acceptance_or_audit_materialization_forbidden': True,
 'external_provenance_audit_path': 'fresh-l2-provenance-audit-0001/QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_PROVENANCE_AUDIT.json',
 'post_acceptance_positive_invocation_reserved_to_reviewer': True,
 'required_actor': 'reviewer',
 'required_agent_layer': 'reviewer',
 'required_run_label': 'reviewer',
 'reviewer_provenance_gate_file_sha256': '8ea6c7d05b7b6a35c5d83923ac5d95e6f4e1d56e9656e006b7d7d4c6d5a55b8e',
 'reviewer_provenance_gate_path': 'tools/reviewer_provenance_v27.py'}
EXPECTED_BYTECODE_CONTRACT = {
    "candidate_entrypoint": "tools/verify_qk_gbfp8_head64_role_enforced_acceptance_candidate_v27.py",
    ...
    "post_acceptance_entrypoint": "tools/verify_qk_gbfp8_head64_role_enforced_acceptance_post_acceptance_v27.py",
...
EXPECTED_LITERAL_B_CONTRACT = {
    ...
    "launch_guard_absolute_path_required": True,
    "launch_guard": "tools/literal_b_launch_guard_v27.py",
    "launch_guard_file_sha256": "3e3f6b1211b6000c4239abf69ecca95a15750e7ef36f0e37387f365267be1d6a",
    "launch_matrix": "tools/verify_qk_gbfp8_head64_literal_b_launch_matrix_v27.py",
...
EXPECTED_FORBIDDEN_PATHS = [
    str(CANONICAL_ACTION_ROOT / "live"),
    str(PROJECT_ROOT / "runtime/qk_gbfp8_head64_role_enforced_acceptance_v27_aaa22c19"),
...
EXPECTED_STATIC_POLICY = {
    ...
    "allowed_relative_files": [
        "QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_PACKAGE.json",
        ...
        "reference/QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_FRESH_L2_ACCEPTANCE_SCHEMA.json",
        "review/FRESH_L2_STATIC_ACCEPTANCE.json",
        "tools/validate_qk_gbfp8_head64_source_oracle_b0_v23.py",
        "tools/reviewer_provenance_v27.py",
        "tools/literal_b_launch_guard_v27.py",
        "tools/verify_qk_gbfp8_head64_literal_b_launch_matrix_v27.py",
        "tools/verify_qk_gbfp8_head64_role_enforced_acceptance_candidate_v27.py",
        "tools/verify_qk_gbfp8_head64_role_enforced_acceptance_post_acceptance_v27.py",
    ],
...
def audit_hook(event: str, args: tuple[Any, ...]) -> None:
    if event == "open" and args:
        ...
        if _inside(path, ACTION_ROOT) and _open_is_mutating(args):
            raise VerificationError(f"V26 action-tree write prohibited: {path}")
    ...
    if event in {"os.remove", "os.rmdir", "os.mkdir", "os.rename", "os.replace", "os.chmod", "os.link", "os.symlink"}:
        for value in args[:2]:
            ...
            if _inside(path, ACTION_ROOT):
                raise VerificationError(f"V26 action-tree mutation prohibited: {event}:{path}")
    if event == "subprocess.Popen":
        AUDIT["official_target_process_starts"] += 1
        raise VerificationError("process start prohibited in inert V26 verifier")
...
def validate_static_contract(package: dict[str, Any]) -> None:
    require(package["artifact_kind"] == "qk_gbfp8_head64_role_enforced_acceptance_static_v27_package", "package kind")
    require(package["authoritative_stage"] == "Base", "authoritative stage")
    require(package["root_id"] == "qk_gbfp8_head64_role_enforced_acceptance_static_v27_action_root", "root id")
    ...
    require(package["v25_preservation"] == EXPECTED_V25_PRESERVATION, "terminal V25 preservation")
    require(package["v26_preservation"] == EXPECTED_V26_PRESERVATION, "terminal provenance-invalid V26 preservation")
    require(package["role_enforcement"] == EXPECTED_ROLE_ENFORCEMENT, "V27 role enforcement contract")
...
def verify_inventory(package: dict[str, Any], allow_acceptance: bool) -> dict[str, Any]:
    ...
    for path in sorted(ACTION_ROOT.rglob("*")):
        info = os.lstat(path)
        require(not stat.S_ISLNK(info.st_mode), f"V26 symlink: {path}")
        relative = path.relative_to(ACTION_ROOT).as_posix()
        if stat.S_ISDIR(info.st_mode):
            observed_directories.add(relative)
            continue
        require(stat.S_ISREG(info.st_mode), f"V26 non-regular file: {relative}")
    ...
    require(observed == expected, f"V26 inventory expected={sorted(expected)} observed={sorted(observed)}")
    require(observed_directories == expected_directories, f"V26 directories expected={sorted(expected_directories)} observed={sorted(observed_directories)}")
    records = inventory_records(ACTION_ROOT)
    assert_no_forbidden_inventory(records, package["bytecode_free_verifier_contract"], "V26 inventory")
    root_mode = f"{stat.S_IMODE(os.lstat(ACTION_ROOT).st_mode):04o}"
    require(root_mode == "0555", "V26 action root mode seal")
    for record in records:
        if record["kind"] == "directory":
            expected_mode = "0555" if allow_acceptance or record["path"] != "review" else "0755"
            require(record["mode"] == expected_mode, f"V26 directory mode seal: {record['path']}")
        else:
            require(record["mode"] == "0444", f"V26 file mode seal: {record['path']}")
    ...
    require(normalized_seal_records == package["mode_seal"]["pre_acceptance_records"], "V26 pre-acceptance mode-seal manifest")
...
def verify_v25_preservation() -> dict[str, Any]:
    require(inventory_digest(V25_ROOT) == EXPECTED_V25_PRESERVATION["v25_action_root"], "terminal V25 action tree drift")
    require(f"{stat.S_IMODE(os.lstat(V25_ROOT).st_mode):04o}" == EXPECTED_V25_PRESERVATION["action_root_mode"], "terminal V25 action-root mode drift")
    require(not os.path.lexists(EXPECTED_V25_PRESERVATION["acceptance_absent"]), "terminal V25 acceptance unexpectedly exists")
    paths = {
        "checkpoint": V25_CHECKPOINT,
        "construction_record": V25_CONSTRUCTION_RECORD,
        "matrix_stderr": V25_MATRIX_STDERR,
        "package": V25_PACKAGE,
        "terminal_failure": V25_TERMINAL_FAILURE,
    }
    for key, path in paths.items():
        record = EXPECTED_V25_PRESERVATION[key]
        require(path.stat().st_size == record["size"] and sha256_file(path) == record["sha256"], f"terminal V25 preserved file drift: {key}")
    package, _ = canonical(V25_PACKAGE)
    terminal = json_object(V25_TERMINAL_FAILURE)
    require(package["action_identity"]["action_id"] == EXPECTED_V25_ACTION_ID, "terminal V25 action identity")
    require(terminal["status"] == "TERMINAL_V25_REQUIRES_DISTINCT_V26", "terminal V25 status")
    require(terminal["failure_taxonomy"] == EXPECTED_V25_PRESERVATION["terminal_failure_taxonomy"], "terminal V25 failure taxonomy")
    records = inventory_records(V25_ROOT)
    for record in records:
        if record["kind"] == "directory":
            expected_mode = EXPECTED_V25_PRESERVATION["review_directory_mode"] if record["path"] == "review" else "0555"
        else:
            expected_mode = "0444"
        require(record["mode"] == expected_mode, f"terminal V25 mode drift: {record['path']}")
    normalized: list[dict[str, Any]] = [{"kind": "directory", "mode": EXPECTED_V25_PRESERVATION["action_root_mode"], "path": "."}]
    for record in records:
        item = dict(record)
        if item["path"] == V25_PACKAGE.name:
            item.pop("sha256")
            item["sha256_field"] = "package_content_sha256"
            item["sha256_scope"] = "canonical_object_without_package_content_sha256"
        normalized.append(item)
    require(normalized == package["mode_seal"]["pre_acceptance_records"], "terminal V25 mode manifest drift")
    return {
        "acceptance_absent": True,
        "package_file_sha256": EXPECTED_V25_PRESERVATION["package"]["sha256"],
        "terminal_failure_verified": True,
        "v25_action_tree_sha256": EXPECTED_V25_PRESERVATION["v25_action_root"]["tree_sha256"],
    }



def verify_v26_preservation() -> dict[str, Any]:
    require(inventory_digest(V26_ROOT) == {key: value for key, value in EXPECTED_V26_PRESERVATION["v26_action_root"].items() if key != "tree_with_root_sha256"}, "terminal V26 action tree drift")
    with_root = [{"kind": "directory", "mode": f"{stat.S_IMODE(os.lstat(V26_ROOT).st_mode):04o}", "path": "."}, *inventory_records(V26_ROOT)]
    require(sha256_bytes(compact_bytes(with_root)) == EXPECTED_V26_PRESERVATION["v26_action_root"]["tree_with_root_sha256"], "terminal V26 rooted action tree drift")
    require(f"{stat.S_IMODE(os.lstat(V26_ROOT).st_mode):04o}" == EXPECTED_V26_PRESERVATION["action_root_mode"], "terminal V26 root mode")
    paths = {
        "acceptance": V26_ACCEPTANCE,
        "checkpoint": V26_CHECKPOINT,
        "negative_fixture_report": V26_NEGATIVE_REPORT,
        "package": V26_PACKAGE,
        "positive_post_report": V26_POST_REPORT,
        "review_rejection": V26_REVIEW_HANDOFF,
    }
    for key, path in paths.items():
        record = EXPECTED_V26_PRESERVATION[key]
        require(path.stat().st_size == record["size"] and sha256_file(path) == record["sha256"], f"terminal V26 preserved file drift: {key}")
    package, _ = canonical(V26_PACKAGE)
    acceptance, _ = canonical(V26_ACCEPTANCE)
    post, _ = canonical(V26_POST_REPORT)
    rejection = json_object(V26_REVIEW_HANDOFF)
    checkpoint = V26_CHECKPOINT.read_text(encoding="utf-8")
    require(package["action_identity"]["action_id"] == EXPECTED_V26_ACTION_ID, "terminal V26 action identity")
    require(acceptance["accepted"] is True and acceptance["reviewer_role"] == "Fresh-L2", "terminal V26 acceptance bytes")
    require(post["status"] == "PASS_V26_STATIC_POST_ACCEPTANCE_LITERAL_B_MODE_SEALED", "terminal V26 positive post report")
    require(rejection["review"]["status"] == "replan_requested", "terminal V26 Reviewer rejection")
    require(EXPECTED_V26_PRESERVATION["invalid_creator_call_id"] in checkpoint and "engineer-r2" in checkpoint, "terminal V26 invalid creator provenance")
    for record in inventory_records(V26_ROOT):
        expected_mode = EXPECTED_V26_PRESERVATION["review_directory_mode"] if record["kind"] == "directory" and record["path"] == "review" else ("0555" if record["kind"] == "directory" else "0444")
        require(record["mode"] == expected_mode, f"terminal V26 mode drift: {record['path']}")
    return {
        "acceptance_file_sha256": EXPECTED_V26_PRESERVATION["acceptance"]["sha256"],
        "package_file_sha256": EXPECTED_V26_PRESERVATION["package"]["sha256"],
        "positive_post_report_file_sha256": EXPECTED_V26_PRESERVATION["positive_post_report"]["sha256"],
        "provenance_invalid_acceptance_preserved": True,
        "review_rejection_verified": True,
        "v26_action_tree_sha256": EXPECTED_V26_PRESERVATION["v26_action_root"]["tree_with_root_sha256"],
    }


def verify_role_enforcement() -> dict[str, Any]:
    require(sha256_file(REVIEWER_PROVENANCE_GATE) == EXPECTED_ROLE_ENFORCEMENT["reviewer_provenance_gate_file_sha256"], "Reviewer provenance gate hash")
    gate = load_module(REVIEWER_PROVENANCE_GATE, "v27_bound_reviewer_provenance_gate")
    require(gate.ACTION_ID == EXPECTED_ACTION_ID, "Reviewer provenance gate action binding")
    require(gate.MISSION_ID == "v27roleenforcedacceptance", "Reviewer provenance gate mission binding")
    require(gate.REQUIRED_RUN_LABEL == gate.REQUIRED_ACTOR == gate.REQUIRED_AGENT_LAYER == "reviewer", "Reviewer provenance gate role binding")
    return {
        "acceptance_creator_reserved_to_authoritative_reviewer": True,
        "gate_file_sha256": EXPECTED_ROLE_ENFORCEMENT["reviewer_provenance_gate_file_sha256"],
        "required_actor": gate.REQUIRED_ACTOR,
        "required_agent_layer": gate.REQUIRED_AGENT_LAYER,
        "required_run_label": gate.REQUIRED_RUN_LABEL,
    }
...
def verify_launch_catalog() -> dict[str, Any]:
    ...
    require(catalog["artifact_kind"] == "qk_gbfp8_head64_role_enforced_acceptance_v27_launch_negative_catalog", "launch catalog kind")
...
def verify_v22_and_predecessors() -> dict[str, Any]:
    ...
    v22 = load_module(V22_CANDIDATE_VERIFIER, "v26_bound_v22_candidate_verifier")
...
def _replay_v26_mutation_paths(package: dict[str, Any], report_key: str, expected_count: int) -> dict[str, Any]:
    source, source_raw = canonical(V26_NEGATIVE_REPORT)
    paths = source[report_key]["rejected_mutation_paths"]
    require(len(paths) == source[report_key]["rejected_mutation_count"] == expected_count, f"V26 carried mutation catalog: {report_key}")
    rejected = []
    for dotted in paths:
        path = [int(part) if part.isdigit() else part for part in dotted.split(".")]
        changed = deepcopy(package)
        original: Any = changed
        for part in path:
            original = original[part]
        ...
        try:
            validate_static_contract(changed)
            if dotted.startswith("mode_seal."):
                verify_inventory(changed, False)
        except VerificationError:
            rejected.append(dotted)
        else:
            raise VerificationError(f"fail-closed carried V26 mutation accepted: {dotted}")
    return {"rejected_mutation_count": len(rejected), "rejected_mutation_paths": rejected, "source_v26_negative_report_file_sha256": sha256_bytes(source_raw)}


def verify_v25_extension_mutations(package: dict[str, Any]) -> dict[str, Any]:
    return _replay_v26_mutation_paths(package, "v25_extension_mutations", 165)


def verify_v26_extension_mutations(package: dict[str, Any]) -> dict[str, Any]:
    return _replay_v26_mutation_paths(package, "v26_extension_mutations", 23)


def verify_v27_extension_mutations(package: dict[str, Any]) -> dict[str, Any]:
    rejected = []
    for section in ("v26_preservation", "role_enforcement"):
        for relative in _scalar_paths(package[section]):
            ...
            try:
                ...
                raise VerificationError(f"fail-closed V27 extension mutation accepted: {path}")
    inherited_fresh = {"acceptance_path", "acceptance_schema_file_sha256", "acceptance_schema_path", "decision_requested", "engineer_self_review_can_close", "launch_matrix_independent_reproduction_required", "required_role", "static_acceptance_grants_execution_authority", "status"}
    for key in sorted(set(package["fresh_l2_review"]) - inherited_fresh):
        changed = deepcopy(package)
        original = changed["fresh_l2_review"][key]
        changed["fresh_l2_review"][key] = _mutated_scalar(original)
        try:
            validate_static_contract(changed)
        except VerificationError:
            rejected.append(f"fresh_l2_review.{key}")
        else:
            raise VerificationError(f"fail-closed V27 Fresh-L2 role mutation accepted: {key}")
    role_relative = EXPECTED_ROLE_ENFORCEMENT["reviewer_provenance_gate_path"]
    changed = deepcopy(package)
    changed["generated_files"][role_relative]["sha256"] = "0" * 64
    try:
        validate_static_contract(changed)
        verify_generated_files(changed)
    except VerificationError:
        rejected.append(f"generated_files.{role_relative}.sha256")
    else:
        raise VerificationError("fail-closed V27 role gate generated-file mutation accepted")
...
def verify_v23_style_normal_import_fixture() -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="ace2-v26-normal-import-negative-") as directory:
        root = Path(directory)
...
def verify_no_live_effects(package: dict[str, Any]) -> dict[str, Any]:
    for value in package["forbidden_live_paths"]:
        require(not os.path.lexists(value), f"forbidden V26 live path exists: {value}")
...
def build_negative_report(package: dict[str, Any]) -> dict[str, Any]:
    ...
    report = {
        "artifact_kind": "qk_gbfp8_head64_role_enforced_acceptance_v27_synthetic_negative_fixture_report",
        ...
        "v26_extension_mutations": verify_v26_extension_mutations(package),
        "v27_extension_mutations": verify_v27_extension_mutations(package),
        "status": "PASS_V27_LITERAL_B_MODE_SEAL_AND_SYNTHETIC_MUTATION_REJECTION",
    }
...
def verify(allow_acceptance: bool = False, launch_proof: dict[str, Any] | None = None) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    assert_no_forbidden_inventory(action_before, package["bytecode_free_verifier_contract"], "V26 action tree before verifier")
    negative = build_negative_report(package)
    inventory = verify_inventory(package, allow_acceptance)
    report = {
        "artifact_kind": "qk_gbfp8_head64_role_enforced_acceptance_static_v27_candidate_verifier_report",
        ...
        "status": "PASS_V27_STATIC_CANDIDATE_PENDING_FRESH_L2",
        "v23_preservation": verify_v23_preservation(),
        "v24_preservation": verify_v24_preservation(),
        "v25_preservation": verify_v25_preservation(),
        "v26_preservation": verify_v26_preservation(),
        "role_enforcement": verify_role_enforcement(),
        "v27_execution_authority_granted": False,
    }
    action_after = inventory_records(ACTION_ROOT)
    root_mode_after = f"{stat.S_IMODE(os.lstat(ACTION_ROOT).st_mode):04o}"
    require(action_after == action_before and root_mode_after == root_mode_before, "V26 candidate verifier mutated exact action tree or root mode")
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=BUILD_ROOT / "QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_CANDIDATE_REPORT.json")
    parser.add_argument("--negative-output", type=Path, default=BUILD_ROOT / "QK_GBFP8_HEAD64_ROLE_ENFORCED_ACCEPTANCE_STATIC_V27_NEGATIVE_FIXTURE_REPORT.json")
    ...
    for path in (args.output, args.negative_output):
        try:
            ...
            raise VerificationError(f"V26 report output must stay inside declared build root: {path}") from error
