...
ROOT = Path("/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v16_schema_fixture_repair_shellfree_action_root")
RUNTIME_CONTAINER = Path("/home/argustest/ace-2/runtime")
RUNTIME_ROOT = Path("/home/argustest/ace-2/runtime/qk_gbfp8_head64_granularity_sweep_execution_v16_schema_fixture_repair_e4c05735")
...
ACCEPTED_PATHS = {
    ...
    "package": Path("/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v16_schema_fixture_repair_shellfree_action_root/accepted/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_STATIC_V8_PACKAGE.canonical.json"),
    "result_schema": Path("/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v16_schema_fixture_repair_shellfree_action_root/accepted/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_STATIC_V8_RESULT_SCHEMA.canonical.json"),
...
LOCAL_PATHS = {
    ...
    "result_validation": ROOT / "tools/qk_gbfp8_head64_granularity_sweep_result_validation_v16.py",
...
def _freeze_execution_plan(context: PreflightContext, prepared: PreparedRecords) -> ExecutionPlan:
    ...
    result_validation = bind_result_validators(result_validator, result_bindings, ACTION_ID)
