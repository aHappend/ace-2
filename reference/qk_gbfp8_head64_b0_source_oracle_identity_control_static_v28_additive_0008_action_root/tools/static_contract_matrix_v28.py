...
FUTURE_RUNTIME_NAMESPACE = Path('/home/argustest/ace-2/runtime/qk_gbfp8_head64_b0_source_oracle_identity_control_v28_38571d38_additive_0008_once')
ACCEPTANCE_CREATOR_RELATIVE = 'build/v28-b0-source-oracle-identity-control-static-0013/create_fresh_l2_static_acceptance_v28.py'
EXPECTED_REVIEW_ROOT = Path('/home/argustest/ace-2/build/v28-b0-source-oracle-identity-control-static-0013/fresh-l2-sealed-0001')
EXPECTED_ACTION_ROOT = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_b0_source_oracle_identity_control_static_v28_additive_0008_action_root')
...
def validate_package(package: dict[str, Any]) -> None:
    ...
    require(package["predecessor_preservation"]["failed_additive_predecessor"]["status"] == 'IMMUTABLE_FAILED_SEALED_V28_ADDITIVE_0007', "failed additive predecessor semantics")
