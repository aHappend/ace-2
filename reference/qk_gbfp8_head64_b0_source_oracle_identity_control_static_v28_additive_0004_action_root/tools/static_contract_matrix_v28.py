...
FUTURE_RUNTIME_NAMESPACE = Path('/home/argustest/ace-2/runtime/qk_gbfp8_head64_b0_source_oracle_identity_control_v28_38571d38_additive_0004_once')
...
def tree_hash(root: Path) -> str:
    return sha256_bytes(compact_bytes(inventory(root)))
...
def validate_package(package: dict[str, Any]) -> None:
    ...
    require(package["predecessor_preservation"]["failed_additive_predecessor"]["status"] == "IMMUTABLE_FAILED_SEALED_V28_ADDITIVE_0003", "failed additive predecessor semantics")
...
def verify_identities(package: dict[str, Any]) -> dict[str, Any]:
    ...
    for snapshot in PREDECESSOR_SNAPSHOTS:
        require(tree_hash(Path(snapshot["root"])) == snapshot["tree_sha256"], f"predecessor drift: {snapshot['version']}")
...
def authority_baseline() -> dict[str, Any]:
    ...
    value = {
        ...
        "identity_bundle_sha256": 'b26f1e8ed728e8591d9009c6c1a09200bceb9a35dbf2badea58cc24a2bdccf54',
