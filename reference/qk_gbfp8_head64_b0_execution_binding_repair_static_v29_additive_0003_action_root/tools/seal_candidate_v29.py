...
def build_package() -> dict[str, Any]:
    ...
    package: dict[str, Any] = {
        "action_identity": {
            ...
            "root_id": "qk_gbfp8_head64_b0_execution_binding_repair_static_v29_additive_0003_action_root",
        ...
        "regression_contract": {
            ...
            "required_cases": [
                ...
                "capsule substitution between lstat/open and before final move",
        ...
        "runtime_ordering": {
            ...
            "ordered_steps": [
                ...
                "recheck claim liveness immediately before crossing protected payload/evaluator/target boundary",
            ],
        ...
        "static_review_output_paths": {
            ...
            "post_report": str(C.PROJECT_ROOT / "build/v29-b0-execution-binding-repair-static-0003/fresh-l2-post-0003/V29_POST_ACCEPTANCE_REPORT.json"),
        },
