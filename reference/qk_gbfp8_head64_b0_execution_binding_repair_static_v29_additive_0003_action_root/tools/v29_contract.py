...
ACTION_ROOT = PROJECT_ROOT / "reference/qk_gbfp8_head64_b0_execution_binding_repair_static_v29_additive_0003_action_root"
...
STATIC_ACTION_ID = "ace2:qk-gbfp8-base-v29:b0-execution-binding-repair:7f3c1a62:additive-0003"
EXECUTION_ACTION_ID = "ace2:qk-gbfp8-base-v29:b0-source-oracle-identity-control-execute-once:7f3c1a62:additive-0003"
...
RUNTIME_NAMESPACE = PROJECT_ROOT / "runtime/qk_gbfp8_head64_b0_source_oracle_identity_control_v29_7f3c1a62_additive_0003_once"
FAILURE_SEAL_NAMESPACE = Path(str(RUNTIME_NAMESPACE) + ".failed-start")
AUTHORITY_NAMESPACE = PROJECT_ROOT / "external/qk_gbfp8_head64_b0_source_oracle_identity_control_v29_7f3c1a62_additive_0003_authority"
MANAGER_CAPSULE = AUTHORITY_NAMESPACE / "manager-admission.json"
OPERATOR_CAPSULE = AUTHORITY_NAMESPACE / "operator-authority.json"
CANDIDATE_REPORT = PROJECT_ROOT / "build/v29-b0-execution-binding-repair-static-0003/fresh-l2-sealed-0003/V29_CANDIDATE_REPORT.json"
