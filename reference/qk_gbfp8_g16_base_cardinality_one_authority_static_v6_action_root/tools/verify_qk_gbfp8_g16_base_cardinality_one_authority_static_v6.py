#!/usr/bin/env python3
"""Synthetic-only verifier for the isolated-root Base G16 V6 compatibility package."""
...
ACTION_ROOT_ID = "qk-gbfp8-g16-base-cardinality-one-authority-static-v6-action-root"
PACKAGE_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V6_PACKAGE.json"
SIDECAR_REL = PACKAGE_REL + ".sha256"
PACKAGE_PATH = ROOT / PACKAGE_REL
SIDECAR_PATH = ROOT / SIDECAR_REL
VERIFIER_PATH = Path(__file__).resolve()
CONTROLLER_REL = "reference/qk_gbfp8_g16_base_cardinality_one_authority_controller_static_v6.py"
...
AUTHORITY_REVIEW_MISSION_ID = "26ae5f11a613"
AUTHORITY_REVIEW_DIRECTORY = Path(
    "/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/26ae5f11a613"
)
AUTHORITY_REVIEW_MISSION_PATH = AUTHORITY_REVIEW_DIRECTORY / "mission.json"
AUTHORITY_REVIEW_MISSION_SHA256 = "58e432b1acfee8f5d5d256407252c1bce21bcc9ea243337e1c3ccc211d91edc6"
...
V5_ACTION_ROOT = SOURCE_REPOSITORY_ROOT / "reference/qk_gbfp8_g16_base_cardinality_one_authority_static_v5_action_root"
V5_FAILURE_DIRECTORY = Path(
    "/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/872248a2c6a7"
)
V5_FAILURE_ACTION_ID = "ace2:g16-base-v5:execute-once-v5ns:e326d1bf:26516d60:20260813T1140Z"
V5_PROTECTED_TENSOR = (
    V5_ACTION_ROOT
    / "evidence/diagnostics/w4a8-c02-attention-substage-trace-v2/base/attention-substage-tensors.bin"
)
V5_FROZEN_BINDINGS = {
    SOURCE_REPOSITORY_ROOT / "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V5_ACTION_ROOT_MANIFEST.json": "03fadd7f871f3617f6c5da622a9ab638d1567b364b6dad0975ce9b9de21fb2b4",
    SOURCE_REPOSITORY_ROOT / "verification/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V5_STATIC_REVIEW.json": "f39ee850bdaae39cf3673d4e2b5091a03bf61049670624e30b0ad49bea6a2974",
    V5_ACTION_ROOT / "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V5_PACKAGE.json": "e326d1bf00e476a458fc649ddcf2dcb2b8f10c0f7fd1e4d49ba7bd25a94fc8ff",
    V5_ACTION_ROOT / "reference/qk_gbfp8_g16_base_cardinality_one_authority_controller_static_v5.py": "6400ee1991f0c21220a11e8eb3d617abce7905d7462b2ddf5a066c5fb9539eb0",
    V5_ACTION_ROOT / "tools/verify_qk_gbfp8_g16_base_cardinality_one_authority_static_v5.py": "cf33f6465fa96b8ff87d9164f141b16aca44fa79de3f0f36201245470825c17d",
    V5_ACTION_ROOT / "build/qk-gbfp8-g16-head64-successor-diagnostic-v5-authority/base/authority.json": "22cd5f10d39bc0ba4b7cff8a5f7362266d34bbe1eb3c18cfa479bed08b6043ab",
    V5_ACTION_ROOT / "build/qk-gbfp8-g16-head64-successor-diagnostic-v5-authority/base/credential.json": "964944e8647b2fab4b96f20e1f4fcc9483d08e08e3be42fbf6b27bbe68948790",
    V5_FAILURE_DIRECTORY / "v5-controller-invocation-start.json": "1a9d990f93091143bf68aee4b8dc83efd2dc7a6f0a22c3db5beb7f9170bef065",
    V5_FAILURE_DIRECTORY / "v5-controller-invocation-capture.json": "2a3bab47222e770f8aef9b7c209d001e8633a6c9fbca125a2df0f510f94622c0",
    V5_FAILURE_DIRECTORY / "round-0001.json": "a5e8e29954455cfd0658db4255cf455b6e402f568feb2cc4e808bcde2950670a",
}

G16_PACKAGE_REL = "reference/QK_GBFP8_G16_HEAD64_SUCCESSOR_DIAGNOSTIC_STATIC_V6_PACKAGE.json"
...
G16_EVALUATOR_REL = "reference/qk_gbfp8_g16_head64_successor_diagnostic_static_v6.py"
...
G16_PACKAGE_SHA256 = "5b4d932f6e3ae488997edb080618fbefccf0db617189f85b0e018cc3ec4f67ed"
G16_CONTRACT_SHA256 = "6a5d16c53d482a07e2f20a68a95dc90618d7069858450a2cc5845d85191cf8e4"
G16_SCHEMA_SHA256 = "8d512af26bf39593236098f850ae5477ae13343ffbdeac4fbb207b1b8fd71840"
G16_EVALUATOR_SHA256 = "c6a5744939734deb18506e88a14f0a8b9f3e7f32dc95c2edc2efca2bde9be327"
...
G16_SIDECAR_SHA256 = "afbaa4be332734413812cc2c3c9c5e9051be08a1f8971d6e562291dfe868b4b5"
ACCEPTED_G16_PACKAGE_SHA256 = "33c42fe340867f5b89d451339ca2d552f0bfec3309d8a6103066c171d7806513"

AUTHORITY_PACKAGE_ID = "QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V6"
AUTHORITY_ID = "qk-gbfp8-g16-base-cardinality-one-v6"
AUTHORITY_ROOT_REL = "build/qk-gbfp8-g16-head64-successor-diagnostic-v6-authority"
...
RESULT_ROOT_REL = "build/qk-gbfp8-g16-head64-successor-diagnostic-v6"
...
PACKAGE_SCHEMA_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V6_PACKAGE_SCHEMA.json"
CREDENTIAL_SCHEMA_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_CREDENTIAL_V2_SCHEMA.json"
TERMINAL_SCHEMA_REL = "reference/QK_GBFP8_G16_BASE_FIRST_TERMINAL_V6_SCHEMA.json"
...
BASE_INVOCATION_SHA256 = "1e0b73375883459f3046c6fb270909649166fcf36f7f3831e1eded441072161f"
...
FIRST_TERMINAL_SCHEMA_ID = "QK_GBFP8_G16_BASE_FIRST_TERMINAL_V6"
    ...
    schema_bindings = {
        "authority_package": {
            **repo_binding(PACKAGE_SCHEMA_REL, sha256_file(ROOT / PACKAGE_SCHEMA_REL)),
            "schema_id": "QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V6_PACKAGE_SCHEMA",
        },
        "credential": {
        ...
        "first_terminal": {
            **repo_binding(TERMINAL_SCHEMA_REL, sha256_file(ROOT / TERMINAL_SCHEMA_REL)),
            "schema_id": "QK_GBFP8_G16_BASE_FIRST_TERMINAL_V6_SCHEMA",
        },
    }
    return {
        "action_root_projection": {
            ...
            "evaluator_argv_compatibility_revision": "V6 exact-c02 evaluator and create-only namespaces only",
            "evaluator_argv_exactly_accepted": True,
            "namespace_separation": "All V6 compatibility evaluator paths resolve beneath this distinct V6 action root, never beneath consumed V3, rejected V4, or closed V1/V2 roots.",
        ...
        "accepted_diagnostic": {
            ...
            "compatibility_status": "V6_STATIC_REPAIR_PENDING_FRESH_L2",
        ...
        "artifact_kind": "qk_gbfp8_g16_base_cardinality_one_execution_authority_static_v6_action_root_freeze",
        "authority_controller": {
            ...
            "controller_id": "QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_CONTROLLER_STATIC_V6",
        ...
        "static_verification": {
            "coverage": [
                ...
                "isolated V6 action-root projection and V1-V5 immutability including failed-action no-replay closure",
                ...
                "actual non-consuming AST-extracted controller validator acceptance and exact-key mutations",
        ...
        "v5_failure_immutability": {
            "authority_sha256": "22cd5f10d39bc0ba4b7cff8a5f7362266d34bbe1eb3c18cfa479bed08b6043ab",
            "capture_sha256": "2a3bab47222e770f8aef9b7c209d001e8633a6c9fbca125a2df0f510f94622c0",
            "controller_exit_code": 2,
            "credential_consumed": False,
            "credential_sha256": "964944e8647b2fab4b96f20e1f4fcc9483d08e08e3be42fbf6b27bbe68948790",
            "failure_reason": "authority package exact keys",
            "first_terminal_absent": True,
            "invocation_start_sha256": "1a9d990f93091143bf68aee4b8dc83efd2dc7a6f0a22c3db5beb7f9170bef065",
            "irreversible_action_id": V5_FAILURE_ACTION_ID,
            "ledger_absent": True,
            "mission_id": "872248a2c6a7",
            "replay_permitted": False,
            "result_absent": True,
            "terminal_review_sha256": "a5e8e29954455cfd0658db4255cf455b6e402f568feb2cc4e808bcde2950670a",
        },
        "v6_compatibility_runtime": {
...
CONTROLLER_VALIDATOR_CONSTANTS = {
    "ACTION_ROOT_ID",
    ...
    "EXACT_ENVIRONMENT",
    "FIRST_TERMINAL_REL",
    "FIRST_TERMINAL_SCHEMA_ID",
    "G16_EVALUATOR_SHA256",
    "G16_PACKAGE_SHA256",
    "INTERPRETER_SHA256",
    "LEDGER_REL",
    "NO_VISIBLE_LEDGER_AMBIGUOUS",
    "REQUIRED_DECISION",
    "RESULT_REL",
    "ROOT",
    "SOURCE_REPOSITORY_ROOT",
    "VISIBLE_VALID_LEDGER",
    "ACTION_ID_PATTERN",
}


def controller_validator_namespace(source: str) -> tuple[dict[str, Any], set[str]]:
    tree = ast.parse(source)
    validator = _function_node(tree, "validate_authority_package")
    exact_calls = [
        node
        for node in ast.walk(validator)
        if isinstance(node, ast.Call)
        and isinstance(node.func, ast.Name)
        and node.func.id == "exact_keys"
        and len(node.args) >= 2
        and isinstance(node.args[0], ast.Name)
        and node.args[0].id == "package"
        and isinstance(node.args[1], ast.Set)
    ]
    require(len(exact_calls) == 1, "controller package exact-key call")
    controller_keys = {
        element.value
        for element in exact_calls[0].args[1].elts
        if isinstance(element, ast.Constant) and type(element.value) is str
    }
    require(len(controller_keys) == len(exact_calls[0].args[1].elts), "controller package literal keys")
    body: list[ast.stmt] = [
        ast.ImportFrom(module="__future__", names=[ast.alias(name="annotations")], level=0),
        ast.ImportFrom(module="pathlib", names=[ast.alias(name="Path")], level=0),
    ]
    for node in tree.body:
        if isinstance(node, ast.ClassDef) and node.name == "ControllerError":
            body.append(node)
        elif isinstance(node, ast.Assign):
            names = {target.id for target in node.targets if isinstance(target, ast.Name)}
            if names.intersection(CONTROLLER_VALIDATOR_CONSTANTS):
                body.append(node)
    ...
    namespace: dict[str, Any] = {"__file__": str(CONTROLLER_PATH)}
    exec(compile(module, "<controller-validator-v6>", "exec"), namespace, namespace)
    require("validate_authority_package" in namespace, "controller validator extraction")
    return namespace, controller_keys


def run_extracted_controller_validator(
    namespace: dict[str, Any], package: dict[str, Any], package_sha256: str
) -> None:
    try:
        namespace["validate_authority_package"](
            package,
            package_sha256,
            controller_sha256=package["authority_controller"]["sha256"],
            controller_byte_count=package["authority_controller"]["byte_count"],
            review_mission_sha256=package["authority_review_requirement"]["mission"]["sha256"],
            review_mission_byte_count=package["authority_review_requirement"]["mission"]["byte_count"],
        )
    except Exception as exc:
        raise VerificationError(f"actual controller validator rejected: {exc}") from exc


def controller_validator_regression_from_source(
    source: str, package: dict[str, Any], package_sha256: str
) -> int:
    namespace, controller_keys = controller_validator_namespace(source)
    require(controller_keys == set(package), "package/controller top-level key agreement")
    with tempfile.TemporaryDirectory(prefix="ace2-v6-controller-validator-") as directory:
        scratch = Path(directory)
        require(list(scratch.iterdir()) == [], "validator scratch starts empty")
        run_extracted_controller_validator(namespace, copy.deepcopy(package), package_sha256)
        checks = 3
        for key in sorted(package):
            added = copy.deepcopy(package)
            added[f"{key}_added"] = copy.deepcopy(package[key])
            expect_reject(run_extracted_controller_validator, namespace, added, package_sha256)
            removed = copy.deepcopy(package)
            del removed[key]
            expect_reject(run_extracted_controller_validator, namespace, removed, package_sha256)
            renamed = copy.deepcopy(package)
            renamed[f"{key}_renamed"] = renamed.pop(key)
            expect_reject(run_extracted_controller_validator, namespace, renamed, package_sha256)
            checks += 3
        binding_mutations = [
            (("authority_controller", "evaluator_argv", 3), "reference/substituted.py"),
            (("authority_review_requirement", "mission_id"), "wrong-review-mission"),
            (("authority_review_requirement", "mission_path"), "/tmp/wrong-review.json"),
            (("namespaces", "authority", "path"), "build/substituted/authority.json"),
            (("namespaces", "credential", "path"), "build/substituted/credential.json"),
            (("namespaces", "ledger", "path"), "build/substituted/ledger.json"),
            (("namespaces", "first_terminal", "path"), "build/substituted/terminal.json"),
            (("namespaces", "result", "path"), "build/substituted/result.json"),
        ]
        for path, replacement in binding_mutations:
            candidate = copy.deepcopy(package)
            set_nested(candidate, path, replacement)
            expect_reject(run_extracted_controller_validator, namespace, candidate, package_sha256)
            checks += 1
        require(list(scratch.iterdir()) == [], "validator scratch remains empty")
    return checks + 1


def actual_controller_validator_regression(package: dict[str, Any]) -> int:
    raw = PACKAGE_PATH.read_bytes()
    require(raw == compact_bytes(package), "exact canonical V6 package bytes")
    schema = load_canonical_json(ROOT / PACKAGE_SCHEMA_REL)
    require(set(schema["required"]) == set(package), "package/schema required-key agreement")
    require(set(schema["properties"]) == set(package), "package/schema property-key agreement")
    require(schema["additionalProperties"] is False, "package schema exact-key enforcement")
    package_sha256 = hashlib.sha256(raw).hexdigest()
    source = CONTROLLER_PATH.read_text(encoding="utf-8")
    checks = controller_validator_regression_from_source(source, package, package_sha256)
    weakened = source.replace(
        "type(value) is dict and set(value) == expected",
        "type(value) is dict and expected.issubset(set(value))",
        1,
    )
    require(weakened != source, "exact-key weakening mutation anchor")
    expect_reject(controller_validator_regression_from_source, weakened, package, package_sha256)
    stale = source
    for key in ("v3_terminal_immutability", "v5_failure_immutability", "v6_compatibility_runtime"):
        stale = stale.replace(f'            "{key}",\n', "", 1)
    require(stale != source, "V5 stale allowlist mutation anchor")
    expect_reject(controller_validator_regression_from_source, stale, package, package_sha256)
    return checks + 7
...
def validate_sha256_guard_source(source: str) -> None:
    ...
    v5_tensor = GuardProbePath(("v5-protected-tensor",))
...
def forbidden_payload_guard_checks() -> int:
    ...
    mutations = [
        replace_once(
            "    forbidden = {(ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), (SOURCE_REPOSITORY_ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), V5_PROTECTED_TENSOR.resolve()}\n",
            "    forbidden = {(SOURCE_REPOSITORY_ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), V5_PROTECTED_TENSOR.resolve()}\n",
            "projected path removal",
        ),
        replace_once(
            "    forbidden = {(ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), (SOURCE_REPOSITORY_ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), V5_PROTECTED_TENSOR.resolve()}\n",
            "    forbidden = {(ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), V5_PROTECTED_TENSOR.resolve()}\n",
            "source path removal",
        ),
        replace_once(
            "    forbidden = {(ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), (SOURCE_REPOSITORY_ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), V5_PROTECTED_TENSOR.resolve()}\n",
            "    forbidden = {(ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), (SOURCE_REPOSITORY_ROOT / FORBIDDEN_PAYLOAD_REL).resolve()}\n",
            "V5 protected tensor removal",
        ),
        replace_once(
...
def historical_json_compatibility_checks(package: dict[str, Any]) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="g16-v6-json-") as temporary:
        root = Path(temporary)
        ...
        require(load_canonical_json(canonical) == semantic, "new V6 canonical load")
        checks += 1
    ...
    credential = {
        ...
        "irreversible_action_id": "ace2:g16-base:v6:synthetic",
        "lane_label": "Base",
        "schema_id": CREDENTIAL_SCHEMA_ID,
    }
...
def review_binding_checks(package: dict[str, Any]) -> int:
    ...
    valid = {
        ...
        "review": {
            "next_action": "",
            "operator_question": "",
            "reason": f"Fresh-L2 accepts runtime package {package_sha256}. No V6 authority exists.",
            "status": "done",
        },
        "round": 9999,
        "schema_version": 2,
...
def mutation_checks(package: dict[str, Any]) -> int:
    ...
    mutations = [
        ...
        (("v6_compatibility_runtime", "evaluator", "sha256"), "0" * 64),
        (("v6_compatibility_runtime", "framing", "rank_fields"), "little-endian <H"),
...
def _parse_synthetic(namespace: dict[str, Any], payload: bytes) -> dict[str, dict[str, Any]]:
    with tempfile.TemporaryDirectory(prefix="g16-v6-c02-") as temporary:
...
def verify_static_bindings(package: dict[str, Any]) -> int:
    ...
    for invocation in contract["invocations"]:
        payload = {key: value for key, value in invocation.items() if key != "invocation_sha256"}
        require(
            hashlib.sha256(compact_bytes(payload)).hexdigest() == invocation["invocation_sha256"],
            f"canonical invocation checksum {invocation['lane_label']}",
        )
    ...
    checks += 4 + len(contract["invocations"])
    ...
    require(package["v6_compatibility_runtime"] == expected_runtime, "V6 compatibility runtime closure")
    checks += 1
...
def verify_failed_v5_immutability() -> int:
    checks = 0
    for path, expected_sha256 in V5_FROZEN_BINDINGS.items():
        verify_plain_regular(path)
        require(sha256_file(path) == expected_sha256, f"frozen V5 checksum {path}")
        checks += 1
    verify_plain_regular(V5_PROTECTED_TENSOR)
    require(V5_PROTECTED_TENSOR.stat().st_size == 1305797, "V5 protected tensor byte count")
    checks += 2
    capture = load_static_json(V5_FAILURE_DIRECTORY / "v5-controller-invocation-capture.json")
    require(capture["action_id"] == V5_FAILURE_ACTION_ID, "V5 irreversible action identity")
    require(capture["controller_invocation_number"] == 1, "V5 exactly one controller invocation")
    require(capture["exit_code"] == 2, "V5 controller exit code")
    require(capture["retry_replay_resume_repair_permitted"] is False, "V5 replay closure")
    require(
        capture["stderr_b64"]
        == "",
        "V5 exact stderr evidence",
    )
    review = load_static_json(V5_FAILURE_DIRECTORY / "round-0001.json")
    require(review["producer_role"] == "reviewer", "V5 terminal reviewer role")
    require(review["review"]["status"] == "replan_requested", "V5 terminal review state")
    require("Replay is forbidden" in review["review"]["reason"], "V5 terminal no-replay reason")
    checks += 8
    for path in (
        V5_ACTION_ROOT / "build/qk-gbfp8-g16-head64-successor-diagnostic-v5-authority/base/authority-ledger.json",
        V5_ACTION_ROOT / "build/qk-gbfp8-g16-head64-successor-diagnostic-v5-authority/base/first-terminal.json",
        V5_ACTION_ROOT / "build/qk-gbfp8-g16-head64-successor-diagnostic-v5/base/result.json",
    ):
        verify_absent_plain(path)
        checks += 1
    return checks
...
def normalized_evaluator_ast(source: str) -> str:
    ...
    for index, node in enumerate(tree.body):
        ...
        if isinstance(node, ast.Assign):
            names = {target.id for target in node.targets if isinstance(target, ast.Name)}
            if names.intersection({"AUTHORITY_ROOT_REL", "OUTPUT_ROOT_REL", "PACKAGE_ID", "PACKAGE_REL"}):
                continue
...
def evaluator_compatibility_surface_checks() -> int:
    v6_source = (ROOT / G16_EVALUATOR_REL).read_text(encoding="utf-8")
    accepted_source = ACCEPTED_C02_READER_PATH.read_text(encoding="utf-8")
    ...
    require(normalized_evaluator_ast(v6_source) == normalized_evaluator_ast(v3_source), "V6 evaluator non-reader drift")
    v6_tree = ast.parse(v6_source)
    accepted_tree = ast.parse(accepted_source)
    v3_tree = ast.parse(v3_source)
    reader_nodes = [node for node in ast.walk(v6_tree) if isinstance(node, ast.FunctionDef) and node.name == "read_tensor_bundle"]
    ...
    authoritative_grammar_checks(PRODUCER_PATH.read_text(encoding="utf-8"), accepted_source, v6_source)
    require(
        normalized_reader_function_ast(v6_source, "read_tensor_bundle")
        == normalized_reader_function_ast(accepted_source, "read_tensor_bundle"),
        "V6 reader control flow matches accepted reader",
    )
    require(
        normalized_reader_function_ast(v6_source, "read_exact")
        == normalized_reader_function_ast(accepted_source, "read_exact"),
        "V6 exact-read control flow matches accepted reader",
    )
    require(
        function_ast(v6_tree, "tensor_record_sha256") == function_ast(accepted_tree, "tensor_record_sha256"),
        "V6 per-record digest matches accepted reader",
    )
    require(old_reader_source.count('"little"') >= 6, "V3 little-endian root-cause surface")
    finiteness = [
        node for node in ast.walk(v6_tree) if isinstance(node, ast.FunctionDef) and node.name == "evaluate_selected_records_from_reference"
    ]
    require(len(finiteness) == 1, "reference evaluation function cardinality")
    finiteness_source = ast.get_source_segment(v6_source, finiteness[0]) or ""
...
def controller_prevalidation_ordering_checks() -> int:
    source = CONTROLLER_PATH.read_text(encoding="utf-8")
    tree = ast.parse(source)
    main_source = ast.get_source_segment(source, _function_node(tree, "_main")) or ""
    validation = main_source.find("validate_authority_package(")
    require(validation >= 0, "controller package validation call")
    validator = _function_node(tree, "validate_authority_package")
    validator_calls = {
        node.func.id
        for node in ast.walk(validator)
    ...
    require(
        not validator_calls.intersection(
            {"consume_credential", "create_only_commit", "open", "run", "supervise_and_publish", "unlink"}
        ),
        "controller validator purity surface",
    )
    later_anchors = (
    ...
    for anchor in later_anchors:
        position = main_source.find(anchor)
        require(position > validation, f"controller prevalidation ordering {anchor}")
    return len(later_anchors) + 2
...
def verify_no_execution_surface() -> int:
    ...
    require(
        ...
        and "<controller-validator-v6>" in ast.unparse(_function_node(tree, "controller_validator_namespace")),
        "bounded AST reader/guard/controller-validator extraction",
    )
...
def main() -> int:
    ...
    failed_v5_checks = verify_failed_v5_immutability()
    fresh_l2_review_binding_checks = review_binding_checks(package)
    semantic_mutation_checks = mutation_checks(package)
    actual_controller_validator_checks = actual_controller_validator_regression(package)
    ...
    controller_prevalidation_checks = controller_prevalidation_ordering_checks()
    ...
    print("QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V6=PASS")
    ...
    print(f"V1_V2_CONSUMED_V3_REJECTED_V4_FAILED_V5_IMMUTABILITY_CHECKS={closed_v1_checks + closed_v2_checks + consumed_v3_checks + rejected_v4_checks + failed_v5_checks}")
    ...
    print(f"ACTUAL_CONTROLLER_VALIDATOR_CHECKS={actual_controller_validator_checks}")
    ...
    print(f"CONTROLLER_PREVALIDATION_ORDERING_CHECKS={controller_prevalidation_checks}")
    ...
    print("V6_LIVE_CREDENTIALS=0 V6_READY_RECORDS=0 V6_CONSUMED_LEDGERS=0 V6_RESULT_NAMESPACES=0")
    print("PROJECTED_SEALED_TENSOR_SLOT=ABSENT EVALUATOR_ARGV_COMPATIBILITY_REVISION=V6_EXACT_C02")
    ...
    print("V5_REPLAY_AUTHORIZED=0 V6_MATERIALIZATION_EXECUTION_AUTHORIZED=0")
    return 0
