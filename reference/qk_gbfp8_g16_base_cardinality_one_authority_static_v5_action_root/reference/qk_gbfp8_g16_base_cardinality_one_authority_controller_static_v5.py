#!/usr/bin/env python3
"""Checksum-bound V5 controller for one future isolated-root Base G16 action.
...
AUTHORITY_PACKAGE_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V5_PACKAGE.json"
...
AUTHORITY_REL = "build/qk-gbfp8-g16-head64-successor-diagnostic-v5-authority/base/authority.json"
CREDENTIAL_REL = "build/qk-gbfp8-g16-head64-successor-diagnostic-v5-authority/base/credential.json"
LEDGER_REL = "build/qk-gbfp8-g16-head64-successor-diagnostic-v5-authority/base/authority-ledger.json"
FIRST_TERMINAL_REL = "build/qk-gbfp8-g16-head64-successor-diagnostic-v5-authority/base/first-terminal.json"
RESULT_REL = "build/qk-gbfp8-g16-head64-successor-diagnostic-v5/base/result.json"
...
def validate_authority_package(package: dict[str, Any], package_sha256: str) -> None:
    ...
    require(package["schema_version"] == 5, "authority package schema version")
...
def main() -> int:
    try:
        ...
        payload = {
            ...
            "schema_id": "QK_GBFP8_G16_BASE_AUTHORITY_CONTROLLER_REJECTION_V5",
        }
