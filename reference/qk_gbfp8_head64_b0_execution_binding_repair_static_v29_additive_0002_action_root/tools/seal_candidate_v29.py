...
def build_package() -> dict[str, Any]:
    ...
    package: dict[str, Any] = {
        "action_identity": {
            ...
            "root_id": "qk_gbfp8_head64_b0_execution_binding_repair_static_v29_additive_0002_action_root",
        ...
        "static_review_output_paths": {
            ...
            "post_report": str(C.PROJECT_ROOT / "build/v29-b0-execution-binding-repair-static-0002/fresh-l2-post-0002/V29_POST_ACCEPTANCE_REPORT.json"),
        },
