...
def _load_bound_launch_guard() -> Any:
    ...
    name = "ace2_v26_post_bound_literal_b_launch_guard"
...
import verify_qk_gbfp8_head64_launch_harness_repair_candidate_v26 as candidate
...
def verify_acceptance(package: dict[str, Any]) -> dict[str, Any]:
    ...
    candidate.require(candidate_report["status"] == "PASS_V26_STATIC_CANDIDATE_PENDING_FRESH_L2", "accepted candidate status")
    ...
    candidate.require(negative_report["status"] == "PASS_V26_LITERAL_B_MODE_SEAL_AND_SYNTHETIC_MUTATION_REJECTION", "accepted negative status")
    ...
    candidate.require(matrix_report["status"] == "PASS_V26_LITERAL_B_LAUNCH_MATRIX_PENDING_FRESH_L2", "accepted launch matrix status")
    ...
    expected_dynamic = {
        ...
        "artifact_kind": "qk_gbfp8_head64_launch_harness_repair_static_v26_fresh_l2_acceptance",
...
def verify() -> dict[str, Any]:
    ...
    report = {
        ...
        "artifact_kind": "qk_gbfp8_head64_launch_harness_repair_static_v26_post_acceptance_inert_report",
        "claim_boundary": candidate.EXPECTED_CLAIM,
        ...
        "status": "PASS_V26_STATIC_POST_ACCEPTANCE_LITERAL_B_MODE_SEALED",
