#!/usr/bin/env python3
"""Future Base V14 execute-once launcher behind the frozen shell-free transport.
...
ROOT = Path("/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree_action_root")
RUNTIME_CONTAINER = Path("/home/argustest/ace-2/runtime")
RUNTIME_ROOT = Path("/home/argustest/ace-2/runtime/qk_gbfp8_head64_granularity_sweep_execution_v14_f1eb0abd")
...
PACKAGE = ROOT / "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V14_SHELLFREE_PACKAGE.json"
ACCEPTANCE = ROOT / "review/FRESH_L2_STATIC_ACCEPTANCE.json"
TRANSPORT = ROOT / "tools/qk_gbfp8_head64_granularity_sweep_transport_shellfree_v14.py"
LAUNCHER = ROOT / "tools/qk_gbfp8_head64_granularity_sweep_execute_once_shellfree_v14.py"
...
ACCEPTED_PATHS = {
    ...
    "package": Path("/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree_action_root/accepted/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_STATIC_V8_PACKAGE.canonical.json"),
    "result_schema": Path("/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree_action_root/accepted/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_STATIC_V8_RESULT_SCHEMA.canonical.json"),
...
LOCAL_PATHS = {
    "authority_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V14_SHELLFREE_AUTHORITY_SCHEMA.json",
    "credential_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V14_SHELLFREE_CREDENTIAL_SCHEMA.json",
    "ledger_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V14_SHELLFREE_LEDGER_SCHEMA.json",
    "first_terminal_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V14_SHELLFREE_FIRST_TERMINAL_SCHEMA.json",
    "fresh_l2_acceptance_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V14_SHELLFREE_FRESH_L2_ACCEPTANCE_SCHEMA.json",
    "transport": TRANSPORT,
    "launcher": LAUNCHER,
    "static_verifier": ROOT / "tools/verify_qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree.py",
...
def _validate_package(package: dict[str, Any]) -> None:
    require(package["artifact_kind"] == "qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree_package", "package kind")
...
def _validate_fresh_l2_acceptance(package_bytes: bytes, acceptance_validator: Any) -> str:
    ...
    require(acceptance["artifact_kind"] == "qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree_fresh_l2_static_acceptance", "acceptance kind")
...
def _load_frozen_runtime_modules() -> tuple[ModuleType, ModuleType, ModuleType]:
    ...
    controller = _load_frozen_module("v14_frozen_accepted_v8_controller", ACCEPTED_PATHS["controller"])
    evaluator = _load_frozen_module("v14_frozen_accepted_v8_evaluator", ACCEPTED_PATHS["evaluator"])
    parser_module = _load_frozen_module("v14_frozen_accepted_v8_c02_parser", ACCEPTED_PATHS["c02_parser"])
...
def _probe_create_once(parent: Path, label: str) -> None:
    probe = parent / f".v14-production-{label}-create-once-probe"
    ...
    return sealed(
        {
            "action_id": ACTION_ID,
            "action_retired": True,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree_first_terminal",
...
def _authority(context: PreflightContext) -> dict[str, Any]:
    return sealed(
        {
            "action_id": ACTION_ID,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree_authority",
...
def _credential(authority: dict[str, Any]) -> dict[str, Any]:
    return sealed(
        {
            "action_id": ACTION_ID,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree_credential",
    ...
    return sealed(
        {
            "action_id": ACTION_ID,
            "action_retired": True,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v14_shellfree_consumed_ledger",
            "authority_sha256": authority["authority_sha256"],
