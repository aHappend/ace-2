#!/usr/bin/env python3
"""Future Base V13 execute-once launcher behind the frozen shell-free transport.
...
LOCAL_PATHS = {
    "authority_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V13_SHELLFREE_AUTHORITY_SCHEMA.json",
    "credential_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V13_SHELLFREE_CREDENTIAL_SCHEMA.json",
    "ledger_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V13_SHELLFREE_LEDGER_SCHEMA.json",
    "first_terminal_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V13_SHELLFREE_FIRST_TERMINAL_SCHEMA.json",
    "fresh_l2_acceptance_schema": ROOT / "reference/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V13_SHELLFREE_FRESH_L2_ACCEPTANCE_SCHEMA.json",
    "transport": TRANSPORT,
    "launcher": LAUNCHER,
    "static_verifier": ROOT / "tools/verify_qk_gbfp8_head64_granularity_sweep_execution_v13_shellfree.py",
...
def _validate_package(package: dict[str, Any]) -> None:
    require(package["artifact_kind"] == "qk_gbfp8_head64_granularity_sweep_execution_v13_shellfree_package", "package kind")
...
def _validate_fresh_l2_acceptance(package_bytes: bytes, acceptance_validator: Any) -> str:
    ...
    require(acceptance["artifact_kind"] == "qk_gbfp8_head64_granularity_sweep_execution_v13_shellfree_fresh_l2_static_acceptance", "acceptance kind")
...
def _load_frozen_runtime_modules() -> tuple[ModuleType, ModuleType, ModuleType]:
    ...
    controller = _load_frozen_module("v13_frozen_accepted_v8_controller", ACCEPTED_PATHS["controller"])
    evaluator = _load_frozen_module("v13_frozen_accepted_v8_evaluator", ACCEPTED_PATHS["evaluator"])
    parser_module = _load_frozen_module("v13_frozen_accepted_v8_c02_parser", ACCEPTED_PATHS["c02_parser"])
...
def _authority(context: PreflightContext) -> dict[str, Any]:
    return sealed(
        {
            "action_id": ACTION_ID,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v13_shellfree_authority",
...
def _credential(authority: dict[str, Any]) -> dict[str, Any]:
    return sealed(
        {
            "action_id": ACTION_ID,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v13_shellfree_credential",
    ...
    return sealed(
        {
            "action_id": ACTION_ID,
            "action_retired": True,
            "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v13_shellfree_consumed_ledger",
            "authority_sha256": authority["authority_sha256"],
