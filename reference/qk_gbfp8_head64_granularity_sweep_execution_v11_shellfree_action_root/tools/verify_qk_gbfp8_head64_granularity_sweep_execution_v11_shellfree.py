#!/usr/bin/env python3
"""Inert independent verifier for the Base V11 canonical-byte successor.
...
ACTION_ROOT = PROJECT_ROOT / "reference/qk_gbfp8_head64_granularity_sweep_execution_v11_shellfree_action_root"
PACKAGE_PATH = ACTION_ROOT / "QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V11_SHELLFREE_PACKAGE.json"
LAUNCHER_PATH = ACTION_ROOT / "tools/qk_gbfp8_head64_granularity_sweep_execute_once_shellfree_v11.py"
TRANSPORT_PATH = ACTION_ROOT / "tools/qk_gbfp8_head64_granularity_sweep_transport_shellfree_v11.py"
...
EXPECTED_PACKAGE_KIND = "qk_gbfp8_head64_granularity_sweep_execution_v11_shellfree_package"
...
def verify_acceptance_if_present(package_raw: bytes) -> dict[str, Any] | None:
    ...
    require(acceptance.get("artifact_kind") == "qk_gbfp8_head64_granularity_sweep_execution_v11_shellfree_fresh_l2_static_acceptance", "acceptance kind")
...
def main() -> int:
    ...
    result = {
        ...
        "status": "PASS_V11_CANONICAL_PREFLIGHT_SUCCESSOR_INDEPENDENT_STATIC_VERIFICATION",
