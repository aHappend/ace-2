...
FUTURE_RUNTIME_NAMESPACE = Path('/home/argustest/ace-2/runtime/qk_gbfp8_head64_b0_source_oracle_identity_control_v28_38571d38_additive_0002_once')
...
def validate_package(package: dict[str, Any]) -> None:
    ...
    require(package["predecessor_preservation"]["failed_additive_predecessor"]["status"] == "IMMUTABLE_FAILED_SEALED_V28_ADDITIVE_0001", "failed additive predecessor semantics")
...
def authority_baseline() -> dict[str, Any]:
    ...
    value = {
        ...
        "identity_bundle_sha256": '434f3f73c61992eec5ed663a5e4ef7f854118e08d3fb05f0011499af91d04528',
