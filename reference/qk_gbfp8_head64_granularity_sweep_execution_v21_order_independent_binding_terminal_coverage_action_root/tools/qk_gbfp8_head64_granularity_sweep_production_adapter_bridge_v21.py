#!/usr/bin/env python3
"""Frozen V21 production binding for the shared evaluator adapter."""
...
from qk_gbfp8_head64_granularity_sweep_evaluator_adapter_v21 import (
    AdapterResult,
...
ROOT = '/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v21_order_independent_binding_terminal_coverage_action_root'
WORKER = ROOT + "/tools/qk_gbfp8_head64_granularity_sweep_evaluator_worker_v21.py"
...
def main() -> int:
    raise RuntimeError("PREAUTHORITY_ONLY: V21 has no execution authority")
