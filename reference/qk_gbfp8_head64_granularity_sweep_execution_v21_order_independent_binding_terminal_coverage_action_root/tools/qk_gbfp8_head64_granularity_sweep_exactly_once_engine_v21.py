...
def _owner_claim(action_id: str) -> dict[str, Any]:
    return sealed({
        "action_id": action_id,
        "action_retired": True,
        "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v21_exactly_once_owner_claim",
...
def _authority(bindings: dict[str, Any]) -> dict[str, Any]:
    return sealed({
        ...
        "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v21_exactly_once_authority",
...
def _credential(action_id: str, authority: dict[str, Any]) -> dict[str, Any]:
    ...
    return sealed({
        "action_id": action_id,
        "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v21_exactly_once_credential",
...
def _ledger(bindings: dict[str, Any], authority: dict[str, Any], credential: dict[str, Any]) -> dict[str, Any]:
    return sealed({
        "action_id": bindings["action_id"],
        "action_retired": True,
        "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v21_exactly_once_consumed_ledger",
        "authority_sha256": authority["authority_sha256"],
...
def _terminal(
    ...
    *,
    ...
    return sealed({
        "action_id": action_id,
        "action_retired": True,
        "artifact_kind": "qk_gbfp8_head64_granularity_sweep_execution_v21_exactly_once_first_terminal",
