#!/usr/bin/env python3
"""V21 evaluator worker with production and explicitly synthetic modes."""
...
PACKAGE = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v21_order_independent_binding_terminal_coverage_action_root/QK_GBFP8_HEAD64_GRANULARITY_SWEEP_EXECUTION_V21_ORDER_INDEPENDENT_BINDING_TERMINAL_COVERAGE_PACKAGE.json')
ACCEPTANCE = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v21_order_independent_binding_terminal_coverage_action_root/review/FRESH_L2_STATIC_ACCEPTANCE.json')
...
BINDING_TABLE = Path('/home/argustest/ace-2/reference/qk_gbfp8_head64_granularity_sweep_execution_v21_order_independent_binding_terminal_coverage_action_root/bindings/C02_EXACT_BINDINGS_25.json')
EXPECTED_BINDING_TABLE_SHA256 = '87ab3deb25f77d89b0797d72004b4436f9541987da13a42f44a2bff7f9fa9655'
...
def production(args: argparse.Namespace, raw: bytes) -> int:
    ...
    binding_raw = BINDING_TABLE.read_bytes()
