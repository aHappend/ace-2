#!/usr/bin/env python3
"""Checksum-bound V3 controller for one future isolated-root Base G16 action.
...
AUTHORITY_PACKAGE_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V3_PACKAGE.json"
...
def main() -> int:
    try:
        ...
        payload = {
            ...
            "schema_id": "QK_GBFP8_G16_BASE_AUTHORITY_CONTROLLER_REJECTION_V3",
        }
