#!/usr/bin/env python3
"""Synthetic-only verifier for the isolated-root Base G16 V3 package."""
...
ACTION_ROOT_ID = "qk-gbfp8-g16-base-cardinality-one-authority-static-v3-action-root"
PACKAGE_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V3_PACKAGE.json"
SIDECAR_REL = PACKAGE_REL + ".sha256"
PACKAGE_PATH = ROOT / PACKAGE_REL
SIDECAR_PATH = ROOT / SIDECAR_REL
VERIFIER_PATH = Path(__file__).resolve()
CONTROLLER_REL = "reference/qk_gbfp8_g16_base_cardinality_one_authority_controller_static_v3.py"
...
AUTHORITY_REVIEW_MISSION_ID = "f7b9464aa8ca"
AUTHORITY_REVIEW_DIRECTORY = Path(
    "/home/argustest/.argus-skill-ace2/projects/s-c8ae985b/handoffs/f7b9464aa8ca"
)
AUTHORITY_REVIEW_MISSION_PATH = AUTHORITY_REVIEW_DIRECTORY / "mission.json"
AUTHORITY_REVIEW_MISSION_SHA256 = "a20ee7d5e71093ba979aa9f7f61b892e90f3d75409c968d6637337b52c76b45e"
...
G16_EVALUATOR_REL = "reference/qk_gbfp8_g16_head64_successor_diagnostic_static_v1.py"
...
G16_CONTRACT_SHA256 = "d80dab5c2909e6c6f163e3227a9a2c99d7a4c997c3408d5fb91ebc6087707b08"
...
G16_SIDECAR_SHA256 = "f34a6490bac2aa2a04cdad6f6bdfb60180ca0c969fee98d5d9256fbd4e913221"

AUTHORITY_PACKAGE_ID = "QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V3"
AUTHORITY_ID = "qk-gbfp8-g16-base-cardinality-one-v2"
AUTHORITY_ROOT_REL = "build/qk-gbfp8-g16-head64-successor-diagnostic-v1-authority"
...
PACKAGE_SCHEMA_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V3_PACKAGE_SCHEMA.json"
CREDENTIAL_SCHEMA_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_CREDENTIAL_V2_SCHEMA.json"
TERMINAL_SCHEMA_REL = "reference/QK_GBFP8_G16_BASE_FIRST_TERMINAL_V3_SCHEMA.json"
...
FIRST_TERMINAL_SCHEMA_ID = "QK_GBFP8_G16_BASE_FIRST_TERMINAL_V3"
...
def projected_dependency_bindings(
    ...
    bindings: list[dict[str, Any]] = list(g16_package["artifacts"].values())
    bindings.extend(
        [
            {"path": G16_PACKAGE_REL, "sha256": G16_PACKAGE_SHA256},
            {"path": G16_SIDECAR_REL, "sha256": G16_SIDECAR_SHA256},
            base_lane["metadata"],
        ]
    )
    bindings.extend(
    ...
    schema_bindings = {
        "authority_package": {
            **repo_binding(PACKAGE_SCHEMA_REL, sha256_file(ROOT / PACKAGE_SCHEMA_REL)),
            "schema_id": "QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V3_PACKAGE_SCHEMA",
        },
        "credential": {
        ...
        "first_terminal": {
            **repo_binding(TERMINAL_SCHEMA_REL, sha256_file(ROOT / TERMINAL_SCHEMA_REL)),
            "schema_id": "QK_GBFP8_G16_BASE_FIRST_TERMINAL_V3_SCHEMA",
        },
    }
    return {
        "action_root_projection": {
            ...
            "namespace_separation": "All accepted V1-relative evaluator paths resolve beneath this distinct V3 action root, never beneath the closed repository-root V1 action.",
        ...
        "artifact_kind": "qk_gbfp8_g16_base_cardinality_one_execution_authority_static_v3_action_root_freeze",
        "authority_controller": {
            ...
            "controller_id": "QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_CONTROLLER_STATIC_V3",
        ...
        "static_verification": {
            "coverage": [
                ...
                "isolated action-root projection and closed repository-root V1/V2 immutability",
...
def historical_json_compatibility_checks(package: dict[str, Any]) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="g16-v3-json-") as temporary:
        root = Path(temporary)
        ...
        require(load_canonical_json(canonical) == semantic, "new V3 canonical load")
        checks += 1
    ...
    credential = {
        ...
        "irreversible_action_id": "ace2:g16-base:v3:synthetic",
        "lane_label": "Base",
        "schema_id": CREDENTIAL_SCHEMA_ID,
    }
...
def review_binding_checks(package: dict[str, Any]) -> int:
    ...
    valid = {
        ...
        "review": {
            "next_action": "",
            "operator_question": "",
            "reason": f"Fresh-L2 accepts runtime package {package_sha256}. No V3 authority exists.",
            "status": "done",
        },
        "round": 9999,
        "schema_version": 2,
...
def verify_static_bindings(package: dict[str, Any]) -> int:
    ...
    require(G16_PACKAGE_SHA256 in review.get("review", {}).get("reason", ""), "accepted task review package")
    checks += 4
...
def verify_closed_v1_immutability() -> int:
    authority_root = SOURCE_REPOSITORY_ROOT / AUTHORITY_ROOT_REL
    ...
    result = SOURCE_REPOSITORY_ROOT / RESULT_REL
...
def main() -> int:
    ...
    print("QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V3=PASS")
    ...
    print(f"CLOSED_V1_V2_IMMUTABILITY_CHECKS={closed_v1_checks + closed_v2_checks}")
    ...
    print("PROJECTED_SEALED_TENSOR_SLOT=ABSENT ACCEPTED_EVALUATOR_ARGV=UNCHANGED")
