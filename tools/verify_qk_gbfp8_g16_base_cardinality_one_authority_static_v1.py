#!/usr/bin/env python3
"""Synthetic-only verifier for the frozen Base G16 cardinality-one authority."""
...
PACKAGE_REL = "reference/QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V1_PACKAGE.json"
...
AUTHORITY_REVIEW_MISSION_SHA256 = "f42beb796079b23e9f00e6338dd2f9ed126b8583bc05c29ef5e975bab7f21363"
...
AUTHORITY_ID = "qk-gbfp8-g16-base-cardinality-one-v1"
...
def sha256_file(path: Path) -> str:
    require(path.resolve() != (ROOT / FORBIDDEN_PAYLOAD_REL).resolve(), "sealed tensor payload open")
...
def load_canonical_json(path: Path) -> Any:
    ...
    require(text == pretty_text(value), f"noncanonical JSON {path}")
    return value
...
def expected_package() -> dict[str, Any]:
    ...
    return {
        ...
        "artifact_kind": "qk_gbfp8_g16_base_cardinality_one_execution_authority_static_freeze",
        "authority_controller": {
            ...
            "controller_id": "QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_CONTROLLER_STATIC_V1",
...
def verify_static_bindings(package: dict[str, Any]) -> int:
    ...
    verify_plain_regular(ROOT / TENSOR_REL)
    checks += 3
    return checks
...
def main() -> int:
    ...
    print("QK_GBFP8_G16_BASE_CARDINALITY_ONE_AUTHORITY_STATIC_V1=PASS")
