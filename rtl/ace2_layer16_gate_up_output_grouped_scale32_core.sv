...
module ace2_layer16_gate_up_output_grouped_scale32_core (
    input  wire                 clk_i,
    input  wire                 rst_ni,
    input  wire                 clear_i,
    ...
    input  wire [12:0]          channel_i,
    input  wire                 last_i,

    output wire                 out_valid_o,
    input  wire                 out_ready_i,
    output wire                 stream_o,
    output wire signed [7:0]    q_o,
    output wire [31:0]          group_scale32_o,
    output wire [12:0]          channel_o,
    output wire                 last_o,
