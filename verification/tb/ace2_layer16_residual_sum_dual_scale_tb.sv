...
module ace2_layer16_residual_sum_dual_scale_tb;
    `include "ace2_layer16_residual_sum_dual_scale/ace2_layer16_residual_sum_dual_scale_constants.svh"
    ...
    ace2_layer16_residual_sum_dual_scale_core dut (
        ...
        .down_s8_i(down_s8), .down_scale32_i(down_scale32),
    ...
    initial begin
        ...
        $readmemh("verification/generated/ace2_layer16_residual_sum_dual_scale/residual_s8.hex", residual_mem);
        $readmemh("verification/generated/ace2_layer16_residual_sum_dual_scale/residual_scale32.hex", residual_scale_mem);
        $readmemh("verification/generated/ace2_layer16_residual_sum_dual_scale/down_s8.hex", down_mem);
        $readmemh("verification/generated/ace2_layer16_residual_sum_dual_scale/down_scale32.hex", down_scale_mem);
        $readmemh("verification/generated/ace2_layer16_residual_sum_dual_scale/output_scale32.hex", output_scale_mem);
        $readmemh("verification/generated/ace2_layer16_residual_sum_dual_scale/expected_sum_s8.hex", expected_mem);
        $readmemh("verification/generated/ace2_layer16_residual_sum_dual_scale/expected_saturation.hex", saturation_mem);
        $readmemh("verification/generated/ace2_layer16_residual_sum_dual_scale/expected_common_exponent_s8.hex", common_exponent_mem);
